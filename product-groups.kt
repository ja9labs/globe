...
class Grupo1 {
    ...
    val frutas."180(dias)" = Citros, Maca, Uva
    val frutas."360(dias)" = Melao, Morango, Coco, Goiaba, Caqui, Mamao, Banana, Manga
    val frutas."720(dias)" = Abacate, Abacaxi, Anonaceas, Cacau, Cupuacu, Kiwi, Maracuja, Melancia, Roma, Acai, Acerola, Amora, Ameixa, Caju, Carambola, Figo, Framboesa, Marmelo, Nectarina, Nespera, Pessego, Pitanga, Pêra e Mirtilo
}
...
class Grupo3 {
    ...
    val tipo3.360(dias) = Couve, Agriao, Almeirao, Brocolis, Chicorea, Couve-Flor
...
class Grupo4 {
    ...
    val tipo4.360(dias) = Pimentao, Abobora, Abobrinha
